...
PARENT_AVAILABLE_FIGURES: tuple[dict[str, Any], ...] = (
    {"name": "汤姆·里德尔／伏地魔", "era_status": "已经是成年黑巫师和战争核心人物；不是霍格沃茨学生。", "how_to_use": "通过失踪、袭击、传闻、报纸和成年战争线逐步出现；不得默认出现在校园或让普通学生知道其全部计划。"},
    {"name": "凤凰社", "era_status": "秘密抵抗组织，成员、据点、行动范围和内部情报不向普通学生公开。", "how_to_use": "1978年毕业后通过可信联系人、救援、调查或战争行动逐步接触；成年或正直不等于自动入会。"},
    {"name": "食死徒", "era_status": "战争中的秘密组织，不等同于所有斯莱特林学生、纯血家族或黑魔法爱好者。", "how_to_use": "可作为失踪、威胁、秘密集会和成年黑巫师网络出现；入会必须由实际行动与代价建立。"},
    {"name": "芬里尔·格雷伯克", "era_status": "与狼人袭击和卢平过去有关的危险人物；普通学生通常只听到模糊传闻。", "how_to_use": "可作为满月恐惧、受害者证词、战争线追踪或远方威胁出现；不得无证据安排为当前校园 NPC。"},
    {"name": "魔法部、傲罗办公室与威森加摩", "era_status": "影响案件、通缉、审判、血统政治和公共舆论的行政、执法与司法机构。", "how_to_use": "可通过文件、听证、调查、家族事务和成年职业线出现；普通学生不能默认读取机密档案。"},
    {"name": "《预言家日报》与巫师无线电", "era_status": "传播失踪、袭击、政治表态和战争气氛的公共媒介，报道可能片面、延迟或受审查。", "how_to_use": "可作为远方背景和调查线索；不得用报道替代玩家亲历或把未经证实的传闻写成事实。"},
    {"name": "圣芒戈、古灵阁、对角巷、翻倒巷与霍格莫德", "era_status": "亲世代已经存在的魔法界机构、商业街区和村落，不是自动传送点。", "how_to_use": "可用于治疗、金库、购物、工作、家族社交、黑市传闻和成年生活；到达方式取决于日期、身份和行动。"},
    {"name": "斯内普、莉莉、詹姆与小天狼星的家庭成员", "era_status": "影响同期角色血统观念、经济压力、离家、归属和成年选择的家庭环境。", "how_to_use": "可在假期、书信、家庭拜访、争执和成年过渡中出现；家庭成员不自动知道学校秘密或未来结局。"},
    {"name": "沃尔布加·布莱克、雷古勒斯与布莱克家庭", "era_status": "古老纯血家族的家庭环境；雷古勒斯比小天狼星低一年入学。", "how_to_use": "可用于小天狼星的家庭冲突和雷古勒斯的成长；不能在1971年把雷古勒斯写成同级生。"},
    {"name": "其他霍格沃茨教授和高年级学生", "era_status": "构成1970年代的校园日常，具体姓名和任教安排保留创作空间。", "how_to_use": "可创建符合时代的新 NPC 用于课堂、纪律、社团、魁地奇和高年级社交；持续互动后保持身份连续。"},
    {"name": "穆尔塞伯、艾弗里等斯莱特林黑魔法圈子的同期生", "era_status": "可能接近黑魔法与纯血激进圈子，但不是全体斯莱特林代表。", "how_to_use": "可作为偏见、诱惑、欺凌或危险知识来源；立场和组织归属必须随剧情建立，不能倒灌到低年级。"},
)
...
PARENT_ADULT_CAST_OVERRIDES: dict[str, dict[str, Any]] = {
    item_id: {
        ...
        "role": adult_role,
        "current_life": adult_life,
        "appearance_conditions": adult_appearance,
    }
    for item_id, adult_role, adult_life, adult_appearance in (
        ("james_potter", "已从霍格沃茨毕业的成年巫师，正在面对战争与个人前途", "不再是学生；他可以选择工作、成家、加入抵抗或继续用自己的方式面对战争。", "成年公共生活、波特家庭、战争线或玩家主动联系时出现。"),
        ("sirius_black", "已从霍格沃茨毕业的成年巫师，正在与布莱克家族和战争时代拉开距离", "不再是学生；他可能离家、参与抵抗或承担自己的鲁莽后果，不能提前写成阿兹卡班囚犯。", "成年公共生活、波特与布莱克家庭、战争线或玩家主动联系时出现。"),
        ("remus_lupin", "已从霍格沃茨毕业的成年狼人巫师，正在寻找能容纳自己的生活", "不再是学生；工作、住处和战争立场会受到狼人身份、健康状况和社会偏见影响。", "成年求职、狼人调查、旧同学联系或战争线出现。"),
        ("peter_pettigrew", "已从霍格沃茨毕业的成年巫师，仍在寻找安全感、归属和有利位置", "不再是学生；成年选择取决于恐惧、依附关系和实际压力，不能提前写成叛徒或假死者。", "成年旧友社交、家庭与战争外围场景出现。"),
        ("lily_evans", "已从霍格沃茨毕业的成年女巫，正在建立自己的职业、关系与战争立场", "不再是学生；成年道路由自己的原则、工作、朋友和选择构成，不能只围绕詹姆或斯内普展开。", "成年职业与社交生活、伊万斯家庭、旧同学联系或战争线出现。"),
        ("severus_snape", "已从霍格沃茨毕业的成年巫师，拥有魔药天赋并处在危险的黑魔法选择边缘", "不再是学生，也不是已经任教的魔药课教授；工作、社交圈和战争归属必须逐步形成。", "成年魔药与黑魔法圈子、旧同学联系或战争线出现。"),
    )
}
...
def _parent_date(value: date | str | None) -> date:
...
def _visible_parent_text(text: Any, current_date: date, revealed_facts: Any = ()) -> str:
    raw = str(text or "")
    evidence = str(revealed_facts or "")
    if not raw:
        return ""
    result: list[str] = []
    for sentence in (part.strip() for part in raw.replace("；", "。").split("。")):
        if not sentence:
            continue
        threshold = None
        if any(term in sentence for term in ("阿尼马格斯", "活点地图")):
            threshold = date(1974, 9, 1)
        elif any(term in sentence for term in ("五年级", "1975", "1976", "泥巴种")):
            threshold = date(1975, 9, 1)
        elif any(term in sentence for term in ("毕业后", "1978", "食死徒", "凤凰社")):
            threshold = date(1978, 7, 1)
        elif any(term in sentence for term in ("1981", "波特夫妇", "背叛", "伪造死亡")):
            threshold = date(1981, 10, 31)
        if threshold and current_date < threshold and not any(
            term in evidence for term in ("阿尼马格斯", "活点地图", "泥巴种", "食死徒", "凤凰社", "1981", "背叛")
        ):
            continue
        if not threshold and current_date.year < 1978 and any(
            marker in sentence for marker in ("后来", "后期", "再后来", "日后", "将成为", "会背叛")
        ):
            continue
...
def parent_adult_profile(npc_id: str, current_date: date | str | None) -> dict[str, Any] | None:
    profile = PARENT_ADULT_CAST_OVERRIDES.get(npc_id)
    if profile and _parent_date(current_date) >= date.fromisoformat(profile["start_date"]):
        return dict(profile)
    return None
...
def parent_cast_index(
    ...
    *,
    ...
    story_date = _parent_date(current_date)
    return [
        {
            "npc_id": item["npc_id"],
            "name": item["name"],
            "role": (parent_adult_profile(item["npc_id"], story_date) or {}).get("role", item["role"]),
            "public_identity": item.get("public_identity", ""),
            "appearance": item.get("appearance", ""),
            "stable_traits": item["personality"].rstrip("。").split("、"),
            "background": _visible_parent_text(item.get("background", ""), story_date, revealed_facts),
            "current_life": (parent_adult_profile(item["npc_id"], story_date) or {}).get(
                "current_life",
                _visible_parent_text(item.get("current_life", ""), story_date, revealed_facts),
            ),
            "core_motives": list(item.get("goals", [])),
            "fears": list(item.get("fears", [])),
            "secrets": [
                visible for secret in item.get("secrets", [])
                if (visible := _visible_parent_text(secret, story_date, revealed_facts))
            ],
            "speech_style": item.get("speech_style", ""),
            "relationship_to_player": item.get("relationship_to_player", ""),
            "appearance_conditions": (parent_adult_profile(item["npc_id"], story_date) or {}).get(
                "appearance_conditions", item.get("appearance_conditions", "")
            ),
            "must_not": [
                visible for value in item.get("must_not", [])
                if (visible := _visible_parent_text(value, story_date, revealed_facts))
            ],
        }
